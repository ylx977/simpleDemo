...
public class MailDemo{
	...
	// 发送邮件的账号
    public static String ownEmailAccount = "yanglingxiao2009@163.com";
    // 发送邮件的密码------》授权码
    public static String ownEmailPassword = "13003665386";
    // 发送邮件的smtp 服务器 地址
    public static String myEmailSMTPHost = "smtp.163.com";
    // 发送邮件对方的邮箱
    public static String receiveMailAccount = "yanglingxiao123@qq.com";
	...
	/**  
	    ...
	    */
	    public static Message createSimpleMail(Session session) throws Exception {
	        ...
	        message.setFrom(new InternetAddress(ownEmailAccount, "张三", "utf-8"));
	        // 代表收件人
	        ...
	        message.saveChanges();
	        // 将上面创建的对象写入本地
//	        OutputStream out = new FileOutputStream("C:\\Users\\fuzamei\\Desktop\\MyEmail.eml");
//	        message.writeTo(out);
//	        out.flush();
//	        out.close();
	        return message;
